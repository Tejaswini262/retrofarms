  ...
  return (
    <div className="bg-[#F7F1E5]">
      ...
      <section className="relative min-h-[92vh] flex items-center overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1508930993032-fbbaf4f2821a?auto=format&fit=crop&w=2000&q=80"
          alt="farm"
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 py-24">
          <div className="max-w-2xl">
            ...
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-[#2B1D11] leading-[1.05] mb-8">
              Honest food,<br />grown the old way.
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 bg-[#2B1D11] hover:bg-[#3A2818] text-[#F7F1E5] px-8 py-4 rounded-full transition-colors"
              >
                Shop the Farm <ArrowRight size={17} />
              </Link>
              <Link
                to="/about"
                className="inline-flex items-center gap-2 border border-[#2B1D11]/30 hover:border-[#2B1D11] text-[#2B1D11] px-8 py-4 rounded-full transition-colors"
              >
                Our Story
              </Link>
            </div>
      ...
      <section className="py-24">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="text-center mb-14">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-[#2B1D11] max-w-2xl mx-auto leading-tight">
              Four categories, one honest promise.
            </h2>
            <Link to="/shop" className="inline-block mt-6 text-[#C96C1B] hover:text-[#A85512] transition-colors">
              View entire shop →
            </Link>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {cats.map((c) => (
              <Link
                key={c.id}
                to={`/shop?cat=${c.id}`}
                className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow border border-[#E4D9C1]"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="text-sm text-[#C96C1B] mt-1 group-hover:translate-x-1 transition-transform">
                    Browse →
                  </div>
                </div>
              </Link>
      ...
      <section className="bg-[#EFE4CB] py-24">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-[#2B1D11] leading-tight mb-6">
              Six acres.<br />Countless little miracles.
            </h2>
            ...
            <Link
              to="/about"
              className="inline-flex items-center gap-2 text-[#2B1D11] border-b border-[#2B1D11] pb-1 hover:text-[#C96C1B] hover:border-[#C96C1B] transition-colors"
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            <img
              src="https://images.unsplash.com/photo-1535275226173-7ee8b465f0c1?auto=format&fit=crop&w=1200&q=80"
              alt="chickens"
      ...
      <section className="py-24">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="text-center mb-14">
            ...
            <h2 className="font-serif text-4xl md:text-5xl text-[#2B1D11]">
              Freshly picked, ready to order
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featured.map((p) => (
              <Link
                key={p.slug}
                to={`/product/${p.slug}`}
                className="group bg-white rounded-2xl overflow-hidden border border-[#E4D9C1] shadow-sm hover:shadow-lg transition-shadow"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-[#4B3826]">From ₹{p.fromPrice}</div>
                    <div className="text-[#C96C1B] group-hover:translate-x-1 transition-transform">
                      Order →
                    </div>
                  </div>
                </div>
